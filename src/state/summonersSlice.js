...
export const fetchSummoners = (timestamp, backwards, nameLength) => (
    dispatch,
    getState
) => {
    dispatch(loading());
    ...
    const url = new URL(`${process.env.REACT_APP_BACKEND_URI}/${region.toLowerCase()}/summoners`);
...
export const updateSummoner = (summoner) => (
    dispatch,
    getState
) => {
